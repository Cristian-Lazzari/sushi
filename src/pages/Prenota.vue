    ...
    <div class="prenota-cont">
      ...
      <div class="top-prenota">
        ...
        <div class="categorie" :class="categoryinput ? 'cat-off': ''">
          <div v-for="(cat, i) in arrCategory" class="category" :class="categoryId == cat.id ? 'category-on' : '', i == 0 ? 'category0' : '',i == 1 ? 'category1' : '', i == 2 ? 'category2' : '',i == 3 ? 'category3' : '',i == 4 ? 'category4' : '',i == 5 ? 'category5' : '',i == 6 ? 'category6' : '', i == 7 ? 'category7' : '' " @click="changeCategory(cat.id)" :key="i"> 
...
.ccoff {
  ...
  .close-cart{
     position: sticky;
      ...
      height: 50px;
      color: white;
      border: solid 2px rgba(255, 255, 255, 0.661);
      background-color: $c-header;
      padding: 10px;
      border-radius: 20px;
      text-align: center;
...
.category7{
  background-color:rgba(213, 60, 60, 0.07)!important;
}
.category-on {
  
  background-color: rgba(213, 60, 60,) !important;
}
.cat-off{
